 ...
 * @returns {React.ReactElement} The rendered ShaderBackground component.
 */
function ShaderBackground({
  ...
  const hexToRgb = (hex: string): [number, number, number] => {
    // Remove alpha channel if present and ensure proper format
  ...
  return (
    <div className={`relative w-full min-h-screen ${className}`}>
      ...
      <div className={`relative z-10 ${finalBlurClass}`}>
        {children && (
